...
FROM [curated].[{object_name}]
    ...
    # create_file(enriched, f"./etl/sql_server/{datamart}/enriched/{object_name}.sql")
    create_file(curated, f"./etl/sql_server/{datamart}/curated/{object_name}.sql")
    create_file(model, f"./etl/sql_server/{datamart}/model/{object_name}.sql")