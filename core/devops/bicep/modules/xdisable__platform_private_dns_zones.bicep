...
module m_privateDNSZoneStorageDFS 'private_dns_zone.bicep' = {
...
module m_privateDNSZoneStorageBlob 'private_dns_zone.bicep' = if (ctrlDeployPurview == true || ctrlDeployAI == true){
...
module m_privateDNSZoneStorageQueue 'private_dns_zone.bicep' = if (ctrlDeployPurview == true) {
...
module m_privateDNSZoneStorageFile 'private_dns_zone.bicep' = if (ctrlDeployAI == true) {
...
module m_privateDNSZoneSynapseSQL 'private_dns_zone.bicep' = {
...
//Required for Synapse
module m_privateDNSZoneSynapseDev 'private_dns_zone.bicep' = {
...
//Required for Synapse
module m_privateDNSZoneSynapseWeb 'private_dns_zone.bicep' = {
...
module m_privateDNSZoneKeyVault 'private_dns_zone.bicep' = {
...
module m_privateDNSZoneServiceBus 'private_dns_zone.bicep' = if(ctrlDeployPurview == true || ctrlDeployStreaming == true){
...
module m_privateDNSZonePurviewAccount 'private_dns_zone.bicep' = if(ctrlDeployPurview == true) {
...
module m_privateDNSZonePurviewPortal 'private_dns_zone.bicep' = if(ctrlDeployPurview == true) {
...
module m_privateDNSZoneACR 'private_dns_zone.bicep' = if(ctrlDeployAI == true) {
...
//Required by Azure ML
module m_privateDNSZoneAzureMLAPI 'private_dns_zone.bicep' = if(ctrlDeployAI == true) {
...
//Required by Azure ML
module m_privateDNSZoneAzureMLNotebooks 'private_dns_zone.bicep' = if(ctrlDeployAI == true) {
...
//Required by IoTHub
module m_privateDNSZoneIoTHub 'private_dns_zone.bicep' = if(ctrlDeployStreaming == true) {
...
module m_privateDNSZoneCognitiveService 'private_dns_zone.bicep' = if(ctrlDeployAI == true) {
...
module m_privateDNSZoneCosmosDBSQL 'private_dns_zone.bicep' = if(ctrlDeployCosmosDB == true) {
...
//CosmosDB DNS Zone: privatelink.documents.azure.com
//Required by CosmosDB
module m_privateDNSZoneCosmosDBAnalytics 'private_dns_zone.bicep' = if(ctrlDeployCosmosDB == true) {
